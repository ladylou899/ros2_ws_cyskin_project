...
typedef void CyBtldr_ProgressUpdate(CyBtldr_CommunicationsData *origin, unsigned char arrayId, unsigned short rowNum);
...
*
* Parameters:
*   g_comm   – Communication struct used for communicating with the target device
*
* Returns:
*   CYRET_SUCCESS	    - The abort was sent successfully
*
*******************************************************************************/
EXTERN int CyBtldr_Abort(CyBtldr_CommunicationsData* g_comm);
