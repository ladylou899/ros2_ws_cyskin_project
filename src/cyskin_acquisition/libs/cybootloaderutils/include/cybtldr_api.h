...
#define CYBTLRD_MAX_FLASH_ARRAYS 4
...
public:
	...
	unsigned int MaxTransferSize;
	unsigned long g_validRows[CYBTLRD_MAX_FLASH_ARRAYS];
...
*
*******************************************************************************/
int CyBtldr_TransferData(unsigned char* inBuf, int inSize, unsigned char* outBuf, int outSize, CyBtldr_CommunicationsData *g_comm);
...
*
*******************************************************************************/
int CyBtldr_ValidateRow(unsigned char arrayId, unsigned short rowNum, CyBtldr_CommunicationsData *g_comm);
...
*
*******************************************************************************/
EXTERN int CyBtldr_EndBootloadOperation(CyBtldr_CommunicationsData* g_comm);
...
*
*******************************************************************************/
EXTERN int CyBtldr_GetApplicationStatus(unsigned char appID, unsigned char* isValid, unsigned char* isActive, CyBtldr_CommunicationsData *g_comm);
...
*
*******************************************************************************/
EXTERN int CyBtldr_SetApplicationStatus(unsigned char appID,  CyBtldr_CommunicationsData *g_comm);
...
*
*******************************************************************************/
EXTERN int CyBtldr_ProgramRow(unsigned char arrayID, unsigned short rowNum, unsigned char* buf, unsigned short size, CyBtldr_CommunicationsData *g_comm);
...
*
*******************************************************************************/
EXTERN int CyBtldr_EraseRow(unsigned char arrayID, unsigned short rowNum, CyBtldr_CommunicationsData *g_comm);
...
*
*******************************************************************************/
EXTERN int CyBtldr_VerifyRow(unsigned char arrayID, unsigned short rowNum, unsigned char checksum, CyBtldr_CommunicationsData *g_comm);
...
*
*******************************************************************************/
EXTERN int CyBtldr_VerifyApplication(CyBtldr_CommunicationsData *g_comm);
