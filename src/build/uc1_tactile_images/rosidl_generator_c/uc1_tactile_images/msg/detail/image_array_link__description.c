  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x80, 0x88, 0x8d, 0xc5, 0x60, 0x63, 0x10, 0x04,
      0xfe, 0x18, 0xb9, 0x38, 0x23, 0xfb, 0xc6, 0x5a,
      0x9e, 0xb3, 0xdb, 0x15, 0x44, 0x47, 0xa7, 0x9b,
      0xd1, 0x58, 0x1d, 0xd8, 0x37, 0x99, 0x85, 0x1d,
    }};
  return &hash;
}
...
static char uc1_tactile_images__msg__ImageArrayLink__TYPE_NAME[] = "uc1_tactile_images/msg/ImageArrayLink";
static char builtin_interfaces__msg__Time__TYPE_NAME[] = "builtin_interfaces/msg/Time";
static char sensor_msgs__msg__Image__TYPE_NAME[] = "sensor_msgs/msg/Image";
static char std_msgs__msg__Header__TYPE_NAME[] = "std_msgs/msg/Header";

// Define type names, field names, and default values
static char uc1_tactile_images__msg__ImageArrayLink__FIELD_NAME__images[] = "images";

static rosidl_runtime_c__type_description__Field uc1_tactile_images__msg__ImageArrayLink__FIELDS[] = {
  {
    {uc1_tactile_images__msg__ImageArrayLink__FIELD_NAME__images, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription uc1_tactile_images__msg__ImageArrayLink__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {uc1_tactile_images__msg__ImageArrayLink__TYPE_NAME, 37, 37},
      {uc1_tactile_images__msg__ImageArrayLink__FIELDS, 1, 1},
    },
    {uc1_tactile_images__msg__ImageArrayLink__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *uc1_tactile_images__msg__ImageArrayLink__get_individual_type_description_source(NULL),
